...
\begin{document}
	...
	\label{database}
		...
		Das Programm geht davon aus, dass die ABS-Toolchain (https://github.com/abstools/abstools) auf dem System installiert ist und die ausführbaren Dateien, vor allem der Compiler (\textit{absc}), im \textit{PATH} vorhanden ist. Alternativ kann der Pfad der Toolchain auch über die Konfigurations-Datei bereitgestellt werden.
